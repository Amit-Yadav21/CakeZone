...
function WelcomeCakezone() {
    return (
        <div className='container text-center'>
            <h3 className='m-0 headings-font-family'>About Us</h3>
            <h1 className='.font-faimily'>WELCOME TO CAKEZONE</h1>
            ...
            <div className='d-flex gap-4'>
                ...
                <div className='col-12 col-md-6'>
                    ...
                    <h6 className='font-faimily-1'>Tempor erat elitr at rebum at at clita. Diam dolor diam ipsum et tempor sit. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet magna</h6>
                    <div className='row'>
                        <div className='col-6'>
                            ...
                            <h4>100% HEALTHY</h4>
                            <h6 className='font-faimily-1'>Labore justo vero ipsum sit clita erat lorem magna clita nonumy dolor magna dolor vero</h6>
                        </div>
                        <div className='col-6'>
                            <div className='d-flex align-items-center justify-content-center mt-3 mb-3' style={{ width: '80px', height: '80px', margin: '0 auto', backgroundColor: '#FFA500' }}>
                                <div className='border' style={{ backgroundColor: '#FFA500' }}>
