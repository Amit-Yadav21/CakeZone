...
function DiscountSummer() {
    return (
        <div className="container-fluid py-5" id="Discount-bg-image">
            <div className="container row row-cols-1 row-cols-md-3 mt-3 text-center">
                <div className="col">
                    <div className="card p-3 DiscountCard-bg-color">
                        <h1>BIRTHDAY CAKE</h1>
            ...
            <h1 className='text-white font-faimily-discount mt-4'>30% DISCOUNT FOR THIS SUMMER</h1>
